...
namespace mcprog
{
    class GenaAlfaResetter_rev3free : MicrochipBootloaderHardware, IAT88Programmer, IM24CXXProgrammer, IXerox0190Programmer, IPresetting
    {
        #region Constant
        ...
        public const byte XEROX90_OTP_CLEAR = 0x0F;
        ...
        string _devName = "GenaAlfa Resetter v3";
        bool _isBusy = false;
        string _hardwarePath;
        EventHandler _busy;
        EventHandler _ready;
        HardwareMode _hardwareMode = HardwareMode.UnknownMode;
        GA3FREEResetterInfoForm infoForm = new GA3FREEResetterInfoForm();
        ...
        int IAT88Programmer.ReadChip(string crumType, List<MemoryRegionInfo> reions, Action<ProgrammingCompleteInfo, List<MemoryRegion>> completed, Action<ProgrammingProgressInfo> progress)
        {
            ...
            ThreadStart start = delegate()
            {
                ...
                try
                {
                    ...
                    SetTaskNumber(_hardwarePath, _AT88_CrumVoltage);
        ...
        int IM24CXXProgrammer.ReadChip(string chip, MemoryRegionInfo regionInfo, Action<ProgrammingCompleteInfo, MemoryRegion> completed, Action<ProgrammingProgressInfo> progress)
        {
            ...
            ThreadStart start = delegate()
            {
                ...
                try
                {
                    ...
                    SetTaskNumber(_hardwarePath, _24CXX_CrumVoltage);
        ...
        */
        ...
        int IXerox0190Programmer.ReadChip(string mode, MemoryRegionInfo regionInfo, Action<ProgrammingCompleteInfo, MemoryRegion> completed, Action<ProgrammingProgressInfo> progress)
        {
            ...
            ThreadStart start = delegate()
            {
                ...
                try
                {
                    ...
                    SetTaskNumber(_hardwarePath, _XC01_CrumVoltage);
        ...
        int IXerox0190Programmer.ProgramChip(string mode, MemoryRegion region, Action<ProgrammingCompleteInfo> completed, Action<ProgrammingProgressInfo> progress)
        {
            ...
            ThreadStart start = delegate()
            {
                ...
                IDictionary<string, MemoryRegion> virtualRegions = new Dictionary<string, MemoryRegion>
                {
                    ...
                    {"addresses from C8 to FF", new MemoryRegion(0xC8, 0x38, 1)}
                };
        ...
        #region Ctors
        public GenaAlfaResetter_rev3free(string path)
        {
            _hardwarePath = path;
            ...
            infoForm.resetXC01OTPButton.Click += resetXC01OTPButton_Click;
        ...
        private void resetXC01OTPButton_Click(object sender, EventArgs e)
        {
            ResetXC01OTP();
        }
        ...
        public void ResetXC01OTP()
        {
            byte[] wrdata = new byte[65];
            wrdata[0] = 0;
            wrdata[1] = SELECT_PASSWORD_SET;
            wrdata[2] = XEROX90_OTP_CLEAR;
        ...
        public class QueryResultsResp3
        {
            ...
            public byte PaidFirmwareVersion;
            ...
            QueryResultsResp3(byte[] response)
            {
                ...
                if (MemoryRegionsInfo.Count < 3)
                {
                    ...
                    PaidFirmwareVersion = response[33];
                    DeviceLocking = response[34];
                    NewCoreResetter = response[36];
                    CrumVoltage = (byte)((int)response[35] - (int)((NewCoreResetter<3)?0:1));
