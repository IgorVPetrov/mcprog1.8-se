...
namespace mcprog
{
    class GenaAlfaResetter_v3 : MicrochipBootloaderHardware, IAT88Programmer, IM24CXXProgrammer, IXerox0190Programmer, IPresetting
    {
        ...
        GA3ResetterInfoForm infoForm = new GA3ResetterInfoForm();
        ...
        */
        ...
        #region Ctors
        public GenaAlfaResetter_v3(string path)
        {
            _hardwarePath = path;
